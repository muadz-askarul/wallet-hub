...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <div data-testid="isBiometricEnabled">{isBiometricEnabled.toString()}</div>
...
describe("AppLockProvider", () => {
  ...
  it("should unlock with biometrics if enabled", async () => {
    ...
    ;(authenticateBiometrics as any).mockResolvedValue(true)
  ...
  it("should not unlock with biometrics if it fails", async () => {
    ...
    ;(authenticateBiometrics as any).mockResolvedValue(false)
